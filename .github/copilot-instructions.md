...
**Routing is absolute — follow `.squad/routing.md`:**

| Work Type | Member |
|-----------|--------|
| Automations, scripts, Lovelace, input helpers | **Rusty** |
| Jinja2 templates, template sensors, conditions | **Basher** |
| Z-Wave, Zigbee, MQTT, Docker, Makefile, infra | **Linus** |
| Debugging, log analysis, entity ID research | **Livingston** |
| System architecture, ADRs, design decisions | **Danny** |
| AI integrations, prompt engineering, emerging tech | **Yen** |
| GitHub issues, repo hygiene, releases, workspace config | **Saul** |
